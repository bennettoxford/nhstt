---
title: "How to explore `key_measures` NHS TT report"
...
```{r fig-example, echo=FALSE, fig.height = 12, fig.width = 8, fig.cap = "Trends for counts of (1) referrals received and (2) finished course of treatment for depression broken down by region."}
