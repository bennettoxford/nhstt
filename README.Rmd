...
time_therapy_annual <- benchmark_dataset(
  "therapy_types_annual",
  "2024-25",
  "annual",
  get_therapy_types_annual
)
...
Your times might be a bit faster or slower depending on your internet and computer.
